...
export const PAGE_HELP_CONFIG: Record<string, PageHelpConfig> = {
  ...
  "/tba-data": {
    title: "TBA Data Management",
    useDialog: true,
    content: [
      "Comprehensive data management using The Blue Alliance API for importing match schedules, results, and team information.",
      "**Getting Started:**",
      "1. Get your TBA API key from thebluealliance.com/account (required for all operations)",
      "2. Enter the event key (e.g., '2024chcmp', '2024week0', '2024necmp') for the competition",
      "3. Choose 'Remember for session only' to keep your API key for convenience",
      "",
      ...
      "",
      "• **Event Teams** - Load and store complete team lists for pit scouting and pick lists",
      ...
      "  - Clear stored teams when switching events",
      "",
      "**Tips:**",
      ...
      "- All data is cached locally to reduce API calls and improve performance"
    ]
  },
  "/scout-data-qr": {
